...
import ru.ifmo.web.client.util.JUDDICommand;
import ru.ifmo.web.client.util.Mode;
...
public class Client {
    ...
    public static void main(String... args) throws SQLException_Exception, IOException {
        URL url = new URL("http://localhost:9080/users?wsdl");
    ...
    public static void changeEndpointUrl(String endpointUrl) {
        ((BindingProvider) userPort).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, endpointUrl.trim());
    }
